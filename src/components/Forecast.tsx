	...
	return (
		<div className="w-full md:max-w-[500px] py-4 md:py-4 md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg">
			<div className="mx-auto w-[300px]">
				...
				<section className="flex flex-wrap justify-between text-zinc-700 py-5">
					<div className="w-[140px] text-xs font-bold flex flex-col items-center bg-white/20 backdrop-blur-1g rounded drop-shadowlg py-4 mb-5">
						<Sunrise />{' '}
					...
					<Tile icon="visibility" title="Visibility" info={`${(today.visibiity / 1000).toFixed()} km`} description={getVisibilityValue(today.visibiity)} />
				</section>
			</div>
		</div>
	);
